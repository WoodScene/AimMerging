...
class TrainingArguments:
    ...
    inner_iterations: int = field(default=4, metadata={"help": "Number of inner loop iterations for bi-level optimization."})  # 添加新的参数
    train_batch_size_outer: int = field(default=None, metadata={"help": "The batch size for outer training loop."})  # 添加的新参数
