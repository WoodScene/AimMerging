...
def load_memory_buffer_old(dataset_id, task_id, data_dir, sampling_ratio, cache_dir, random_seed: int = 42):
    """
...
def load_validation_set(data_dir, dataset_id, task_id, cache_dir, val_set_size_per_task=25, seed=42):
    """
