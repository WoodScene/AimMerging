...
class RankAllocator(object):
    ...
    def __init__(
        ...
        self.delta_in_abs_change_list = [] # 用来观察变化量的规律
        self.delta_in_abs_change_step_list = [] # 记录对应的global step，可视化的x轴刻度
        self.inner_step_list = [] # 看一下融合的间隔是怎么变化的

        self.history_loss_list = []
        self.tr_loss_list = []
        self.history_loss_step_list = []



        self.vanilla_abs_change_list = []
        self.vanilla_abs_change_step_list = []
    ...
    def add_delta_in_abs_change(self, total_abs_change, global_step, inner_step):
        #print(f"current abs change: {total_abs_change}")
        self.delta_in_abs_change_list.append(total_abs_change)
        self.delta_in_abs_change_step_list.append(global_step)
        self.inner_step_list.append(inner_step)


    def show_delta_in_abs_change(self):
        return self.delta_in_abs_change_list, self.delta_in_abs_change_step_list, self.inner_step_list


    def get_delta_in_abs_change_list(self):
        return self.delta_in_abs_change_list


    def add_history_loss(self, history_loss, global_step):
        self.history_loss_step_list.append(global_step)
        self.history_loss_list.append(history_loss)

    def add_train_loss(self, tr_loss):
        self.tr_loss_list.append(tr_loss)

    def show_history_loss(self):
        return self.history_loss_list, self.history_loss_step_list, self.tr_loss_list


    def add_delta_vanilla_abs_change(self, vanilla_abs_change, global_step):
        self.vanilla_abs_change_list.append(vanilla_abs_change)
        self.vanilla_abs_change_step_list.append(global_step)

    
    def get_delta_vanilla_abs_change(self):
        return self.vanilla_abs_change_list, self.vanilla_abs_change_step_list
